...
const CustomTooltip = ({ active, payload, label }) => {
  ...
  return (
    ...
    >
      {label && (
        <div className="font-semibold mb-1.5" style={{ color: "#1E293B" }}>
          {label}
        </div>
      )}
      {payload.map((p) => (
...
const PieTooltip = ({ active, payload }) => {
  ...
  return (
    ...
    >
      <div className="font-semibold capitalize" style={{ color: "#1E293B" }}>
        {payload[0].name}
      </div>
      <div
      ...
      <div className="flex items-center gap-3 mb-5">
        ...
        <div>
          ...
          <p className="text-xs" style={{ color: "#94A3B8" }}>
            satisfied vs. unsatisfied users — based on review sentiment
          </p>
        </div>
      </div>
      ...
      <div className="flex items-center gap-4 mb-5">
        {[
          { label: "Satisfied", color: "#28C76F", sub: "positive + neutral" },
          {
            label: "Unsatisfied",
            color: "#EA5455",
            sub: "negative + mixed + sarcastic + ambiguous",
          },
        ].map(({ label, color, sub }) => (
            ...
            >
              <motion.div
                ...
                style={{
                  ...
                  borderRadius:
                    p.satisfiedRate >= 100 ? "99px" : "99px 0 0 99px",
                }}
              />
              <motion.div
                initial={{ width: 0 }}
                ...
                style={{
                  ...
                  borderRadius:
                    p.satisfiedRate === 0 ? "99px" : "0 99px 99px 0",
                }}
              />
            </div>
...
export default function OverviewTab() {
  ...
  const criticalAlerts =
    report.trend_alerts?.filter((a) => a.severity === "critical") || [];
  ...
  const statCards = [
    {
      ...
      sub: `${report.clean_reviews} clean`,
    ...
    },
    {
      ...
      sub: `${botData?.botRate || 0}% of total`,
    ...
    {
      icon: Smile,
      label: "Emojis Detected",
      val: emojiData?.total_emojis_found || 0,
      sub: `${emojiData?.reviews_with_emojis || 0} reviews`,
  ...
  return (
    <div className="space-y-6">
            ...
            >
              ...
              <div className="flex-1">
                <div
                  ...
                  style={{ color: "#DC2626" }}
                >
                  Critical: {alert.feature.replace(/_/g, " ").toUpperCase()} —{" "}
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {statCards.map(
          ({ icon: Icon, label, val, sub, gradient, iconBg, iconColor }, i) => (
            <motion.div
              key={label}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
        ...
        >
          ...
          <p className="section-subtext">
            Complaint vs praise rate per product attribute (%)
          </p>
          <ResponsiveContainer width="100%" height={200}>
        ...
        {botData && (
          ...
          >
            ...
            <div className="space-y-3">
              {[
                ...
                const pct = Math.round(
                  (count / Math.max(report.total_reviews, 1)) * 100,
                );
                return (
                  <div key={level}>
            ...
            >
              ...
              <span className="font-bold" style={{ color: "#28C76F" }}>
                {botData.authenticRate}%
              </span>
            </div>
          </motion.div>
        )}
            ...
            {[
              {
                ...
                val: report.pipeline_version || "2.0",
                color: "#2563EB",
              },
              {
                label: "Decisions Made",
                val: decisions.length,
                color: "#7C3AED",
              },
              {
                label: "Feedback Loops",
                val: feedbackLoops,
                color: feedbackLoops > 0 ? "#D97706" : "#28C76F",
              },
              {
                label: "Languages",
                val: report.languages_detected?.join(", ") || "en",
                color: "#0891B2",
              },
              {
                label: "Categories",
                val: report.product_categories?.length || 1,
                color: "#28C76F",
              },
            ].map(({ label, val, color }) => (
              <div
          ...
          {agentTrace.map((step, i) => (
            ...
            >
              <div
                ...
                style={{
                  background: step.agent.includes("Orchestrator")
                    ? "#EDE9FE"
                    : "#DCFCE7",
